...
extern "C" {
int64_t
lean_int_amount_of_int64(int64_t);
lean_object*
lean_int_amount_of_number(lean_object* number, uint8_t mode);
lean_object*
lean_int_amount_to_number(int64_t v, uint8_t mode);
uint8_t
lean_int_amount_eq(int64_t, int64_t);
uint8_t
lean_int_amount_ne(int64_t, int64_t);
uint8_t
lean_int_amount_eq_int(int64_t, int64_t);
uint8_t
lean_int_amount_ne_int(int64_t, int64_t);
uint8_t
lean_int_amount_lt(int64_t, int64_t);
uint8_t
lean_int_amount_le(int64_t, int64_t);
uint8_t
lean_int_amount_gt(int64_t, int64_t);
uint8_t
lean_int_amount_ge(int64_t, int64_t);
int64_t
lean_int_amount_add(int64_t v1, int64_t v2);
int64_t
lean_int_amount_sub(int64_t v1, int64_t v2);
int64_t
lean_int_amount_neg(int64_t v);
int64_t
lean_int_amount_mul(int64_t v, int64_t rhs);
int64_t
lean_int_amount_add_int(int64_t, int64_t);
int64_t
lean_int_amount_sub_int(int64_t, int64_t);
lean_object*
lean_int_amount_mul_ratio(int64_t v, uint32_t num, uint32_t den, uint8_t roundUp);
}
...
class LeanIntAmount_test : public LeanSuite
{
    static std::string
    fmtVal(int64_t v)
    {
    ...
    checkOfNumber(NumberPair const& p, Number::RoundingMode mode)
    {
        ...
        {
            fail(
                label() + ": error mismatch lean.ok=" + (lean.value.has_value() ? "1" : "0") +
    ...
    // toNumber: C++ side is the implicit `operator Number()` ctor
    bool
    ...
    checkEq(MPTAmountPair const& a, MPTAmountPair const& b)
    {
        return expectBool(
            ...
            a.leanMpt,
            b.leanMpt,
            lean_int_amount_eq(a.leanMpt, b.leanMpt),
            a.cppMpt == b.cppMpt);
    }
    ...
    checkNe(MPTAmountPair const& a, MPTAmountPair const& b)
    {
        return expectBool(
            ...
            a.leanMpt,
            b.leanMpt,
            lean_int_amount_ne(a.leanMpt, b.leanMpt),
            a.cppMpt != b.cppMpt);
    }
    ...
    checkLt(MPTAmountPair const& a, MPTAmountPair const& b)
    {
        return expectBool(
            ...
            a.leanMpt,
            b.leanMpt,
            lean_int_amount_lt(a.leanMpt, b.leanMpt),
            a.cppMpt < b.cppMpt);
    }
    ...
    checkLe(MPTAmountPair const& a, MPTAmountPair const& b)
    {
        return expectBool(
            ...
            a.leanMpt,
            b.leanMpt,
            lean_int_amount_le(a.leanMpt, b.leanMpt),
            a.cppMpt <= b.cppMpt);
    }
    ...
    checkGt(MPTAmountPair const& a, MPTAmountPair const& b)
    {
        return expectBool(
            ...
            a.leanMpt,
            b.leanMpt,
            lean_int_amount_gt(a.leanMpt, b.leanMpt),
            a.cppMpt > b.cppMpt);
    }
    ...
    checkGe(MPTAmountPair const& a, MPTAmountPair const& b)
    {
        return expectBool(
            ...
            a.leanMpt,
            b.leanMpt,
            lean_int_amount_ge(a.leanMpt, b.leanMpt),
            a.cppMpt >= b.cppMpt);
    }
    ...
    {
        return expectBool(
            "eqInt", p.leanMpt, n, lean_int_amount_eq_int(p.leanMpt, n), p.cppMpt == n);
    }
    ...
    {
        return expectBool(
            "neInt", p.leanMpt, n, lean_int_amount_ne_int(p.leanMpt, n), !(p.cppMpt == n));
    }
    ...
    {
        return expectValue("ofInt64", v, 0, lean_int_amount_of_int64(v), MPTAmount{v}.value());
    }
    ...
    checkAdd(MPTAmountPair const& a, MPTAmountPair const& b)
    {
        ...
        return expectValue(
            ...
            a.leanMpt,
            b.leanMpt,
            lean_int_amount_add(a.leanMpt, b.leanMpt),
    ...
    checkSub(MPTAmountPair const& a, MPTAmountPair const& b)
    {
        ...
        return expectValue(
            ...
            a.leanMpt,
            b.leanMpt,
            lean_int_amount_sub(a.leanMpt, b.leanMpt),
            ov ? w : (a.cppMpt - b.cppMpt).value());
    }
    ...
    checkNeg(MPTAmountPair const& a)
    {
        ...
        return expectValue(
            "neg", a.leanMpt, 0, lean_int_amount_neg(a.leanMpt), ov ? w : (-a.cppMpt).value());
    }
    ...
    checkAddInt(MPTAmountPair const& p, int64_t n)
    {
        ...
        return expectValue(
            ...
            p.leanMpt,
            n,
            lean_int_amount_add_int(p.leanMpt, n),
    ...
    checkSubInt(MPTAmountPair const& p, int64_t n)
    {
        ...
        return expectValue(
            ...
            p.leanMpt,
            n,
            lean_int_amount_sub_int(p.leanMpt, n),
            ov ? w : (p.cppMpt - MPTAmount{n}).value());
    }

    // IntAmount inherits XRPAmount's scalar multiply; the int64 product is the oracle.
    bool
    checkMul(MPTAmountPair const& p, int64_t rhs)
    {
        int64_t w;
        bool const ov = __builtin_mul_overflow(p.leanMpt, rhs, &w);
        return expectValue(
            "mul",
            p.leanMpt,
            rhs,
            lean_int_amount_mul(p.leanMpt, rhs),
            ov ? w : (XRPAmount{p.leanMpt} * rhs).drops());
    }
...
public:
    ...
    test_fuzz_of_number()
    {
        beginCase("LeanIntAmount.fuzz_of_number", true);
    ...
    test_fuzz_to_number()
    {
        beginCase("LeanIntAmount.fuzz_to_number", true);
        NumberMantissaScaleGuard sg(MantissaRange::MantissaScale::Large330);
        for (auto mode :
             {Number::RoundingMode::ToNearest,
              Number::RoundingMode::TowardsZero,
    ...
    test_fuzz_add()
    {
        beginCase("LeanIntAmount.fuzz_add", true);
    ...
    test_fuzz_sub()
    {
        beginCase("LeanIntAmount.fuzz_sub", true);
    ...
    test_fuzz_neg()
    {
        beginCase("LeanIntAmount.fuzz_neg", true);
    ...
    test_fuzz_mul_ratio()
    {
        beginCase("LeanIntAmount.fuzz_mul_ratio", true);
        auto& rng = nextRng();
    ...
    test_fuzz_compare()
    {
        beginCase("LeanIntAmount.fuzz_compare", true);
        runFuzz(
    ...
    {
        beginCase("LeanIntAmount.fuzz_compare_int", true);
        auto& rng = nextRng();
        runFuzz(100'000, [&] {
            auto p = randomMPTAmountPair();
    ...
    test_fuzz_of_int64()
    {
        beginCase("LeanIntAmount.fuzz_of_int64", true);
    ...
    {
        beginCase("LeanIntAmount.fuzz_add_sub_int", true);
        auto& rng = nextRng();
        runFuzz(100'000, [&] {
            auto p = randomMPTAmountPair();
            int64_t const n = randomInt64(rng);
    ...
    test_fuzz_mul()
    {
        beginCase("LeanIntAmount.fuzz_mul", true);
        auto& rng = nextRng();
        runFuzz(100'000, [&] {
            auto p = randomMPTAmountPair();
            int64_t const n = randomInt64(rng);
    ...
    test_known_values()
    {
        beginCase("LeanIntAmount.known_values");
        NumberMantissaScaleGuard sg(MantissaRange::MantissaScale::Large330);
    ...
    test_extreme_values()
    {
        beginCase("LeanIntAmount.extreme_values");
        NumberMantissaScaleGuard sg(MantissaRange::MantissaScale::Large330);
        SaveNumberRoundMode save{Number::setround(Number::RoundingMode::ToNearest)};
        ...
        {
            int64_t lean = lean_int_amount_neg(int64Min);
            int64_t cpp;
...
BEAST_DEFINE_TESTSUITE(LeanIntAmount, formal_verification, xrpl);
