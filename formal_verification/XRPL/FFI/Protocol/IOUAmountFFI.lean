...
open XRPL.Model.Protocol (IOUAmount Number rounding_mode)
...
def lean_iou_from_number (n : Number) (mode : rounding_mode) : Except String IOUAmount :=
  IOUAmount.fromNumber n mode

@[export lean_iou_of_mantissa_exp]
def lean_iou_of_mantissa_exp (m : Int64) (e : Int64) (mode : rounding_mode) : Except String IOUAmount :=
  IOUAmount.ofMantissaExp m e.toInt mode

@[export lean_iou_of_number]
def lean_iou_of_number (n : Number) (mode : rounding_mode) : Except String IOUAmount :=
  IOUAmount.ofNumber n mode

@[export lean_iou_to_number]
def lean_iou_to_number (a : IOUAmount) (mode : rounding_mode) : Except String Number :=
  a.toNumber mode
...
@[export lean_iou_lt]
def lean_iou_lt (a b : IOUAmount) (mode : rounding_mode) : Except String Bool :=
  IOUAmount.operator_lt a b mode

@[export lean_iou_le]
def lean_iou_le (a b : IOUAmount) (mode : rounding_mode) : Except String Bool :=
  IOUAmount.operator_le a b mode

@[export lean_iou_gt]
def lean_iou_gt (a b : IOUAmount) (mode : rounding_mode) : Except String Bool :=
  IOUAmount.operator_gt a b mode

@[export lean_iou_ge]
def lean_iou_ge (a b : IOUAmount) (mode : rounding_mode) : Except String Bool :=
  IOUAmount.operator_ge a b mode

@[export lean_iou_neg]
def lean_iou_neg (a : IOUAmount) (mode : rounding_mode) : Except String IOUAmount :=
  a.operator_neg mode

@[export lean_iou_add]
def lean_iou_add (a b : IOUAmount) (mode : rounding_mode) : Except String IOUAmount :=
  IOUAmount.operator_add a b mode

@[export lean_iou_sub]
def lean_iou_sub (a b : IOUAmount) (mode : rounding_mode) : Except String IOUAmount :=
