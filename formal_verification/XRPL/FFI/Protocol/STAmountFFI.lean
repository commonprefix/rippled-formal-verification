...
def lean_stamount_int_amount (s : STAmount) : Except String Int64 :=
  s.intAmount.map (·.value)

@[export lean_stamount_iou]
def lean_stamount_iou (s : STAmount) (mode : rounding_mode) : Except String IOUAmount :=
  s.iou mode

@[export lean_stamount_to_number]
def lean_stamount_to_number (s : STAmount) (mode : rounding_mode) : Except String Number :=
  s.toNumber mode
...
def lean_stamount_checked (numericType : NumericType) (mValue : UInt64) (mOffset : Int64)
    (mIsNegative : UInt8) (mode : rounding_mode) : Except String STAmount :=
...
def lean_stamount_lt (a b : STAmount) : Except String Bool :=
  STAmount.operator_lt a b

@[export lean_stamount_le]
def lean_stamount_le (a b : STAmount) : Except String Bool :=
  STAmount.operator_le a b

@[export lean_stamount_gt]
def lean_stamount_gt (a b : STAmount) : Except String Bool :=
  STAmount.operator_gt a b

@[export lean_stamount_ge]
def lean_stamount_ge (a b : STAmount) : Except String Bool :=
...
def lean_stamount_add (a b : STAmount) (mode : rounding_mode) : Except String STAmount :=
  STAmount.operator_add a b mode

@[export lean_stamount_sub]
def lean_stamount_sub (a b : STAmount) (mode : rounding_mode) : Except String STAmount :=
...
def lean_stamount_can_add (a b : STAmount) (mode : rounding_mode) : Except String Bool :=
  STAmount.canAdd a b mode

@[export lean_stamount_can_subtract]
def lean_stamount_can_subtract (a b : STAmount) : Except String Bool :=
