...
def lean_vault_state_build (assetsTotal : Number) (assetsAvailable : Number) (numericType : NumericType)
    (scale : UInt8) (sharesTotal : Number) (interestUnrealized lossUnrealized : Number) : Vault :=
  { assetsTotal, assetsAvailable, numericType, scale, sharesTotal,
    interestUnrealized, lossUnrealized }
