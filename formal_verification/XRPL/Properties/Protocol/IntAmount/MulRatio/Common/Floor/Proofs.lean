import XRPL.Properties.Protocol.IntAmount.MulRatio.Common.Proofs
...
theorem IntAmount.mulRatio_rounds_floor_proof (amt : IntAmount) (num den : UInt32)
    (result : IntAmount)
  ...
  simpa using IntAmount.mulRatio_rounds_proof amt num den false result hok
