...
/-! ### Sharpness witness for `operator_mul_rounding_bound_to_nearest`
...
lemma scaleDown128_to_nearest_witness :
...
lemma operator_mul_to_nearest_witness :
    Number.operator_mul
  ...
  rw [scaleDown128_to_nearest_witness]
...
theorem operator_mul_to_nearest_attained :
    ∃ (x y result : Number),
  ...
  · norm_isNormalized
  · norm_isNormalized
  · exact operator_mul_to_nearest_witness
  · decide
