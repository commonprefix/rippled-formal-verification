...
theorem operator_mul_algorithmic_facts_upward (x y result : Number)
  ...
  have h_inv := doRoundUp_output_invariants_upward_upTo_maxRepUp g zn zm ze' hzm_ge hzm_le_maxRep .overflow res h_rup hres_mant_ne
  ...
  have h_rup_pos : g.doRoundUp false zm ze' largeRange.min largeRange.max .upward .overflow = .ok res_pos :=
    doRoundUp_false_from_ok g zn zm ze' .upward .overflow res h_rup
