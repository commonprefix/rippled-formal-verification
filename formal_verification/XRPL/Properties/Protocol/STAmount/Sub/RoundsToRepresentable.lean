import XRPL.Properties.Protocol.STAmount.Sub.Common.RoundsToRepresentableProofs

namespace XRPL.Model.Protocol

/-! # Subtraction, discrete/ULP -/

/-- Integral (XRP/MPT) subtraction is exact. -/
theorem STAmount.operator_sub_repr_integral (v1 v2 result : STAmount) (mode : rounding_mode)
...
/-- **IOU subtraction lands within `1` ULP of `v1 − v2` (`to_nearest`).** -/
theorem STAmount.operator_sub_repr_iou (v1 v2 result : STAmount)
  ...
  STAmount.operator_sub_repr_iou_proof v1 v2 result hc1 hc2 h_truth_ne hok hresult

/-- **IOU subtraction lands within `2` ULP of `v1 − v2` (directed modes)** -/
theorem STAmount.operator_sub_repr_iou_directed (v1 v2 result : STAmount)
    (mode : rounding_mode)
    (hc1 : v1.IOUCanonical) (hc2 : v2.IOUCanonical)
    (h_truth_ne : v1.toRat - v2.toRat ≠ 0)
  ...
  STAmount.operator_sub_repr_iou_directed_proof v1 v2 result mode hc1 hc2
